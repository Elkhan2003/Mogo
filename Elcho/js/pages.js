const elcho = document.querySelector("#root");
elcho.innerHTML = `
<!-- ! header -->
		...
		<main class="main">
					...
					<div class="card">
						<div class="card__item">
							<div class="card__inner">
								<div class="card__img">
									<img src="Elcho/img/about/1.jpg" alt="" />
								</div>
						...
						<div class="card__item">
							<div class="card__inner">
								<div class="card__img">
									<img src="Elcho/img/about/2.jpg" alt="" />
								</div>
								<div class="card__text">super team</div>
							</div>
						</div>
						...
						<div class="card__item">
							<div class="card__inner">
								<div class="card__img">
									<img src="Elcho/img/about/3.jpg" alt="" />
								</div>
								<div class="card__text">super team</div>
							</div>
						</div>
					...
					<div class="services">
						<div class="services__item services__item--border">
							<img
								...
								src="Elcho/img/services/photography.png"
								alt="" />
						...
						<div class="services__item services__item--border">
							<img
								class="services__icon"
								src="Elcho/img/services/webdesign.png"
								alt="" />
						...
						<div class="services__item services__item--border">
							<img
								class="services__icon"
								src="Elcho/img/services/creativity.png"
								alt="" />
						...
						<div class="services__item">
							<img
								class="services__icon"
								src="Elcho/img/services/seo.png"
								alt="" />
						...
						<div class="services__item">
							<img
								class="services__icon"
								src="Elcho/img/services/css-html.png"
								alt="" />
						...
						<div class="services__item">
							<img
								class="services__icon"
								src="Elcho/img/services/digital.png"
								alt="" />
			...
			<section class="section section--devices">
				<div class="container">
					...
					<div class="devices">
						<img class="devices__item" src="Elcho/img/ipad.png" alt="" />
						<img
							class="devices__item devices__item--iphone"
							src="Elcho/img/iphone.png"
							alt="" />
					</div>
				</div>
			</section>
				...
				<div class="container">
					...
					<div class="wedo">
						<div class="wedo__item">
							<img class="wedo__img" src="Elcho/img/wedo.jpg" alt="" />
						</div>
				...
				<div class="container">
					...
					<div class="card">
						<div class="card__item">
							<div class="card__inner">
								<div class="card__img">
									<img src="Elcho/img/team/1.jpg" alt="" />
								</div>
						...
						<div class="card__item">
							<div class="card__inner">
								<div class="card__img">
									<img src="Elcho/img/team/2.jpg" alt="" />
								</div>
								<div class="card__text">
									<div class="social">
										<a class="social__item" href="#" target="_blank">
						...
						<div class="card__item">
							<div class="card__inner">
								<div class="card__img">
									<img src="Elcho/img/team/3.jpg" alt="" />
								</div>
								<div class="card__text">
									<div class="social">
										<a class="social__item" href="#" target="_blank">
				...
				<div class="container">
					<div class="logos">
						<div class="logos__item">
							<img class="logos__img" src="Elcho/img/logos/1.png" alt="" />
						</div>
						<div class="logos__item">
							<img class="logos__img" src="Elcho/img/logos/2.png" alt="" />
						</div>
						<div class="logos__item">
							<img class="logos__img" src="Elcho/img/logos/3.png" alt="" />
						</div>
						<div class="logos__item">
							<img class="logos__img" src="Elcho/img/logos/4.png" alt="" />
						</div>
						<div class="logos__item">
							<img class="logos__img" src="Elcho/img/logos/5.png" alt="" />
						</div>
						<div class="logos__item">
							<img class="logos__img" src="Elcho/img/logos/6.png" alt="" />
						</div>
					</div>
				</div>
			</div>
				...
				<div class="works">
					<div class="works__col">
						<div class="works__item">
							<img class="works__image" src="Elcho/img/works/1.jpg" alt="" />
						...
						<div class="works__item">
							<img class="works__image" src="Elcho/img/works/2.jpg" alt="" />
							<div class="works__info">
								<div class="works__title">creatively designed</div>
								<div class="works__text">Lorem ipsum dolor sit</div>
							</div>
					...
					<div class="works__col">
						<div class="works__item">
							<img class="works__image" src="Elcho/img/works/3.jpg" alt="" />
							<div class="works__info">
								<div class="works__title">creatively designed</div>
								<div class="works__text">Lorem ipsum dolor sit</div>
							</div>
						...
						<div class="works__item">
							<img class="works__image" src="Elcho/img/works/4.jpg" alt="" />
							<div class="works__info">
								<div class="works__title">creatively designed</div>
								<div class="works__text">Lorem ipsum dolor sit</div>
							</div>
					...
					<div class="works__col">
						<div class="works__item">
							<img class="works__image" src="Elcho/img/works/5.jpg" alt="" />
							<div class="works__info">
								<div class="works__title">creatively designed</div>
								<div class="works__text">Lorem ipsum dolor sit</div>
							</div>
					...
					<div class="works__col">
						<div class="works__item">
							<img class="works__image" src="Elcho/img/works/6.jpg" alt="" />
							<div class="works__info">
								<div class="works__title">creatively designed</div>
								<div class="works__text">Lorem ipsum dolor sit</div>
							</div>
						...
						<div class="works__item">
							<img class="works__image" src="Elcho/img/works/7.jpg" alt="" />
							<div class="works__info">
								<div class="works__title">creatively designed</div>
								<div class="works__text">Lorem ipsum dolor sit</div>
							</div>
					...
					<div class="blog">
						<div class="blog__item">
							<div class="blog__header">
								<a href="#">
									<img class="blog__photo" src="Elcho/img/blog/1.jpg" alt="" />
								</a>
						...
						<div class="blog__item">
							<div class="blog__header">
								<a href="#">
									<img class="blog__photo" src="Elcho/img/blog/2.jpg" alt="" />
								</a>
								<div class="blog__date">
									<div class="blog__date-day">15</div>
									Jan
						...
						<div class="blog__item">
							<div class="blog__header">
								<a href="#">
									<img class="blog__photo" src="Elcho/img/blog/3.jpg" alt="" />
								</a>
								<div class="blog__date">
									<div class="blog__date-day">15</div>
									Jan
						...
						<div class="footer__col footer__col--second">
							...
							<div class="blogs">
								<div class="blogs__item">
									<img class="blogs__img" src="Elcho/img/blog/1.jpg" alt="" />
								...
								<div class="blogs__item">
									<img class="blogs__img" src="Elcho/img/blog/2.jpg" alt="" />
									<div class="blogs__content">
								...
								<div class="blogs__item">
									<img class="blogs__img" src="Elcho/img/blog/3.jpg" alt="" />
									<div class="blogs__content">
										<a class="blogs__title" href="#"
											>Lorem ipsum dolor sit amet, consectetur adipiscing</a
										>
						...
						<div class="footer__col footer__col--third">
							...
							<div class="instagram">
								<a class="instagram__item" href="#" target="_blank">
									<img src="Elcho/img/instagram/1.jpg" alt="" />
								</a>
								<a class="instagram__item" href="#" target="_blank">
									<img src="Elcho/img/instagram/2.jpg" alt="" />
								</a>
								<a class="instagram__item" href="#" target="_blank">
									<img src="Elcho/img/instagram/3.jpg" alt="" />
								</a>
								<a class="instagram__item" href="#" target="_blank">
									<img src="Elcho/img/instagram/4.jpg" alt="" />
								</a>
								<a class="instagram__item" href="#" target="_blank">
									<img src="Elcho/img/instagram/5.jpg" alt="" />
								</a>
								<a class="instagram__item" href="#" target="_blank">
									<img src="Elcho/img/instagram/6.jpg" alt="" />
								</a>
								<a class="instagram__item" href="#" target="_blank">
									<img src="Elcho/img/instagram/7.jpg" alt="" />
								</a>
								<a class="instagram__item" href="#" target="_blank">
									<img src="Elcho/img/instagram/8.jpg" alt="" />
								</a>
								<a class="instagram__item" href="#" target="_blank">
									<img src="Elcho/img/instagram/9.jpg" alt="" />
								</a>
							</div>
						</div>
					</div>
